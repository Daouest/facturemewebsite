...
export default function PublicitePage() {
    ...
    const prev = () => {
        ...
        setCurrentIndex((prev) =>
            prev - maxImage < 0 ? Math.max(0, (data.length-1) - maxImage) : prev - maxImage
        );
            ...
            <div className="text-white flex flex-col items-center justify-center mt-20">
                ...
                <section className="w-full  max-w-4xl mt-16 px-6 mb-10">
                    ...
                    <div className="flex flex-row">
                          <AiOutlineArrowLeft onClick={prev} className=" mr-10 cursoir cursor-pointer" color="white" size={50} />
                     ...
                     <AiOutlineArrowRight onClick={next} className=" ml-10 cursoir cursor-pointer" color="white" size={50} />
