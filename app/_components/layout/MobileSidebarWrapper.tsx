...
export default function MobileSidebarWrapper({
  ...
  return (
    <>
      ...
      {/* Sidebar */}{" "}
      <aside
        className={`          fixed lg:relative top-20 lg:top-0 left-0           h-[calc(100vh-5rem)] lg:h-auto          w-full lg:w-auto          transform transition-transform duration-300 ease-in-out          ${isSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}          z-50 lg:z-auto          lg:flex-shrink-0          overflow-y-auto        `}
      >
        {" "}
        {children}{" "}
      </aside>{" "}
