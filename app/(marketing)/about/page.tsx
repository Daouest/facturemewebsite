...
export const metadata: Metadata = {
  ...
  description: "Découvrez l'équipe derrière FactureMe, votre solution de gestion de factures simplifiée. | Discover the team behind FactureMe, your simplified invoice management solution.",
  keywords: ["FactureMe", "équipe", "à propos", "facturation", "team", "about", "invoicing"],
};
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 pb-20">
          ...
          >
            <CreatorCard
              ...
              description="Passionné par le développement web, Isaac a apporté son expertise en React et Next.js."
              extraMargin
            />
            <CreatorCard
              id="emerikContainer"
              ...
              description="Passionné par le développement web, Emerik a créé une interface utilisateur fluide et attrayante."
            />
            <CreatorCard
              id="lucianoContainer"
              name="Luciano Gomez"
              ...
              linkedinUrl="https://www.linkedin.com/in/sabri-bouzid-4b724b231/"
              githubUrl="https://github.com/SabriBouzid"
              description="Expert en architecture backend, Luciano a conçu une base solide pour l'application."
              extraMargin
            />
            <CreatorCard
              id="sabrinaContainer"
              ...
              githubUrl="https://github.com/SabriBouzid"
              description="Spécialiste en UX/UI, Sabrina a optimisé l'expérience utilisateur de bout en bout."
            />
          </section>
        </main>
      </div>
